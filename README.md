...
In this project you will build such a pipeline. The runs and the artifacts of the pipeline are documented [here|https://wandb.ai/grit-pientka/nyc_airbnb?workspace=user-grit-pientka].
The content of this github repository is [here|https://github.com/GritP/build-ml-pipeline-for-short-term-rental-prices].
